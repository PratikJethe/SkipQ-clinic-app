...
class AppConfig {
  ...
  String get androidAppId => firebaseRemoteConfig.getString("CLINIC_ANDROID_APP_ID");
  ...
  Future<bool> isUpdateRequired() async {
    ...
    print(firebaseRemoteConfig.getString('ANDROID_CLINIC_APP_MIN_STABLE_VERSION'));
    Version appVersion = Version.parse(packageInfo.version);
    Version minStableVersion = Version.parse(firebaseRemoteConfig.getString('ANDROID_CLINIC_APP_MIN_STABLE_VERSION'));
